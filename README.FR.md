...
```
[Voir la License](https://github.com/BrightDV/BlackHole/blob/main/LICENSE)
...
Les contributions sont les bienvenues. Merci de lire notre [code de conduite des contributions](https://github.com/BrightDV/BlackHole/blob/main/CONTRIBUTING.md) avant de contribuer.

## Vous rencontrez un problème ?

Regardez les [Problèmes communs](https://github.com/BrightDV/BlackHole/wiki/Common-Issues) que vous rencontrez peut-être. Si votre problème n'y est pas, n'hésitez pas à ouvrir une Issue :)
...
Pour lire tous les changements, visitez la [page du wiki](https://github.com/BrightDV/BlackHole/wiki/Changelog)
